...
describe('legacy compatibility loader', () => {
  it('preserves the existing startup order', () => {
    ...
    expect(LEGACY_SCRIPT_PATHS).toContain('/src/js/supabase-browser.js');
    expect(LEGACY_SCRIPT_PATHS.indexOf('/src/js/supabase-browser.js')).toBeLessThan(
      LEGACY_SCRIPT_PATHS.indexOf('/src/js/auth-ui.js'),
    );
